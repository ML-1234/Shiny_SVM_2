...
shinyServer(function(input, output) {
  ...
  output$comp1 <- renderText({paste("<br/>","<br/>",
                                    "<p>&nbsp;&nbsp;&nbsp;Afin de comparer efficacement les modèles présentés dans la partie précédente (dont les choix des paramètres, s'ils ont été modifiés, sont repris ici), nous avons choisi de vous montrer à la fois les techniques usuelles (courbe ROC, AUC et taux d’erreur) et celles plus adaptées aux données asymétriques. </p>",
